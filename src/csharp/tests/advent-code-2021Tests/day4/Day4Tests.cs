...
{
    private readonly Day4 _target = new();
    ...
    public async Task Measurements_Part_1_Matches()
    {
        ...
        Assert.Equal(28082, part1Result);
    }
