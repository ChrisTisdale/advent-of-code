...
public class Day52023Tests
{
    ...
    {
        Assert.Equal(new DateOnly(2023, 12, 5), _target.Year);
    }
    ...
    public async Task Measurements_Part_1_Matches()
    {
        ...
        Assert.Equal(836040384L, part1Result);
    }
    ...
    public async Task Measurements_Part_2_Matches()
    {
        ...
        Assert.Equal(10834440L, part1Result);
    }
}
