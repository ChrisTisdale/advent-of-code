...
public class Day92023Tests
{
    ...
    {
        Assert.Equal(new DateOnly(2023, 12, 9), _target.Year);
    }
    ...
    public async Task Measurements_Part_1_Matches()
    {
        ...
        Assert.Equal(1834108701L, part1Result);
    }
