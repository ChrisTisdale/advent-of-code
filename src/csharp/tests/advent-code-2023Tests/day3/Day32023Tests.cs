...
public class Day32023Tests
{
    ...
    {
        _target.Year.Should().Be(new DateOnly(2023, 12, 3));
    }
    ...
    public async Task Measurements_Part_2_Matches()
    {
        ...
        part1Result.Should().Be(84289137L);
    }
}
