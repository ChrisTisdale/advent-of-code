...
public class AddOperation : IOperation
{
    ...
    public AddOperation(IOperation? left, ulong right)
    {
        _left = left;
        _right = right;
    }
...
public class MultiplyOperation : IOperation
{
    ...
    public MultiplyOperation(IOperation? left, ulong right)
    {
        _left = left;
        _right = right;
    }
...
public class ConcatenateOperation : IOperation
{
    ...
    public ConcatenateOperation(IOperation? left, ulong right)
    {
        _left = left;
        _right = right;
    }
    ...
    public ulong Handle()
    {
        return ulong.Parse($"{_left?.Handle() ?? 0}{_right}");
    }
}

public sealed record Calibration(ulong Expected, IReadOnlyList<IOperation> Operations);
